...
class DataService {
    ...
    private let shirts = [
        Product(title: "Devslopes Logo Graphic T-Shirt Black", price: "$25", imageName: "shirt01.png"),
        Product(title: "Devslopes Badge T-Shirt Light Grey", price: "$25", imageName: "shirt02.png"),
        Product(title: "Devslopes Logo Graphic T-Shirt Red", price: "$25", imageName: "shirt03.png"),
        Product(title: "Hustle Delegate T-Shirt Dark Grey", price: "$25", imageName: "shirt04.png"),
        Product(title: "Kickflip Stuios T-Shirt Black", price: "$25", imageName: "shirt05.png")
    ]
